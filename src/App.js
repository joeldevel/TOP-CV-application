...
let education = {
    ...
    title: "education",
    data: [
        { label: "name", name: "name", value: "Sooftware engineer" },
        { label: "title", name: "title", value: "" },
        { label: "date", name: "date", value: "joao@gmail.com" },
    ],
};
...
let workExperience = {
    ...
    data: [
        ...
        { label: "position", value: "CTO" },
        { label: "main task", value: "calling clients" },
        { label: "from", value: "some date" },
        { label: "to", value: "some date" },
    ],
};
...
function App() {
    ...
    function handleChange(e) {
        ...
        if (section == "info") {
            ...
            const searchIndex = education.findIndex(
                (edu) => edu.id == e.target.dataset.id
            );
            ...
            // find object in array using data-id
            const searchIndex = workExperience.findIndex(
                (exp) => exp.id == e.target.dataset.id
            );
            // // update field using name
    ...
    const addWorkExperience = () => {
        ...
        setWorkExperience((oldExperience) => [
            ...oldExperience,
            {
                id: uniqid(),
                company: "",
    ...
    const removeWorkExperience = (id) => {
        console.log(id);
        const newWorkExperienceArray = workExperience.filter(
            (exp) => exp.id !== id
        );
        ...
        <div className="app">
            <div className="edit-panel">
                ...
                <div className="controls-container">
                    <button className="control-button" onClick={resetFields}>
                        Reset
                    </button>
                    ...
                    <ReactToPrint
                        documentTitle="My CV"
                        trigger={() => (
                            <button className="control-button print-button">
                                Print CV
                            </button>
                        )}
            ...
            <div className="preview-panel">
                ...
                <div
                    className="cv-container myDivToPrint"
                    ref={(el) => (componentRef = el)}
                >
                    <div
                        className="cv-header"
                        style={{ background: headingBg, color: headingColor }}
                    >
                        <h1>
                            {generalInfo.firstname.length !== 0
